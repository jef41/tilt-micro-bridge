...
`{colour}_temp_offsets` is a list starting with the temperature unit and followed by list pairs of `[raw values, calibration points]`, described in more detail [in the Calibration section](/README.md#Calibration)
