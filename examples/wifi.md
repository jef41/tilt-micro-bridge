...
`check_interval` expressed in seconds, at about this interval (randomised beween 80% &ndash; 120%) the bridge will attempt a DNS lookup of Google (8.8.8.8), this is a rudimentary check that we can connect to the internet (or at least a router).
